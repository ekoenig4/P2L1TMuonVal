# Very ugly macro that looks at Stub level information: to be rewritten
...
stubQuality2D = formatHisto2D(
    "stubQuality2D", "stubQuality vs NStubs", 5, -0.5, 4.5, 5, -0.5, 4.5)
pos2D = formatHisto2D("pos2D", "eta Region vs phi Region",
                      13, -6.5, 6.5, 40, -1, 39)

depth = formatHisto("depth", "depth", 6, -0.5, 5.5)
NStations = formatHisto("NStations", "Stations Crossed", 6, 0, 6)

NStationsPt = formatHisto2D(
    "NStations2D", "Stations Crossed", 6, 0, 6, 100, 0, 100)


stubQualityEta2D = formatHisto2D(
    "stubQualityEta2D", "stubQuality vs Eta Region", 5, -0.5, 4.5, 13, -6.5, 6.5)
stubQualityPhi2D_Barrel = formatHisto2D(
    "stubQualityPhi2D_Barrel", "stubQuality vs Phi Region (Barrel) ", 5, -0.5, 4.5, 40, -1, 39)
stubQualityPhi2D_Endcap = formatHisto2D(
    "stubQualityPhi2D_Endcap", "stubQuality vs Phi Region (Endcap) ", 5, -0.5, 4.5, 40, -1, 39)
stubQualityDepth2D = formatHisto2D(
    "stubQualityDepth2D", "stubQuality vs Depth", 5, -0.5, 4.5, 6, -0.5, 5.5)

depthEta2D = formatHisto2D(
    "depthEta2D", "depth vs Eta Region", 6, -0.5, 5.5, 13, -6.5, 6.5)
depthPhi2D_Barrel = formatHisto2D(
    "depthPhi2D_Barrel", "depth vs Phi Region (Barrel)", 6, -0.5, 5.5, 40, -1, 39)
depthPhi2D_Endcap = formatHisto2D(
    "depthPhi2D_Endcap", "depth vs Phi Region (Endcap)", 6, -0.5, 5.5, 40, -1, 39)

depthNStubs2D = formatHisto2D(
    "depthNStubs2D", "depth of stubs vs total NStubs", 6, -0.5, 5.5, 5, -0.5, 4.5)

depthNStubsV22D = formatHisto2D(
    "depthNStubsV22D", "NStubs in each Station per event", 6, -0.5, 5.5, 5, -0.5, 4.5)

depthNStubsV22D_2to5 = formatHisto2D(
    "depthNStubsV22D_2to5", "NStubs in each Station per event (2-5 GeV)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_5to10 = formatHisto2D(
    "depthNStubsV22D_5to10", "NStubs in each Station per event (5-10 GeV)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_Over10 = formatHisto2D(
    "depthNStubsV22D_Over10", "NStubs in each Station per event (>10 GeV)", 6, -0.5, 5.5, 5, -0.5, 4.5)

depthNStubsV22D_2to5_B = formatHisto2D(
    "depthNStubsV22D_2to5_B", "NStubs in each Station per event (2-5 GeV, Barrel)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_5to10_B = formatHisto2D(
    "depthNStubsV22D_5to10_B", "NStubs in each Station per event (5-10 GeV, Barrel)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_Over10_B = formatHisto2D(
    "depthNStubsV22D_Over10_B", "NStubs in each Station per event (>10 GeV, Barrel)", 6, -0.5, 5.5, 5, -0.5, 4.5)

depthNStubsV22D_2to5_E = formatHisto2D(
    "depthNStubsV22D_2to5_E", "NStubs in each Station per event (2-5 GeV, Endcap)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_5to10_E = formatHisto2D(
    "depthNStubsV22D_5to10_E", "NStubs in each Station per event (5-10 GeV, Endcap)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_Over10_E = formatHisto2D(
    "depthNStubsV22D_Over10_E", "NStubs in each Station per event (>10 GeV, Endcap)", 6, -0.5, 5.5, 5, -0.5, 4.5)

depthNStubsV22D_2to5_O = formatHisto2D(
    "depthNStubsV22D_2to5_O", "NStubs in each Station per event (2-5 GeV, Overlap)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_5to10_O = formatHisto2D(
    "depthNStubsV22D_5to10_O", "NStubs in each Station per event (5-10 GeV, Overlap)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_Over10_O = formatHisto2D(
    "depthNStubsV22D_Over10_O", "NStubs in each Station per event (>10 GeV, Overlap)", 6, -0.5, 5.5, 5, -0.5, 4.5)


depthNStubsV22D_2to5_NStubs2 = formatHisto2D(
    "depthNStubsV22D_2to5_NStubs2", "NStubs in each Station per event (2-5 GeV)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_5to10_NStubs2 = formatHisto2D(
    "depthNStubsV22D_5to10_NStubs2", "NStubs in each Station per event (5-10 GeV)", 6, -0.5, 5.5, 5, -0.5, 4.5)
depthNStubsV22D_Over10_NStubs2 = formatHisto2D(
    "depthNStubsV22D_Over10_NStubs2", "NStubs in each Station per event (>10 GeV)", 6, -0.5, 5.5, 5, -0.5, 4.5)
...
MuonPtStubQual2Or3Stubs = formatHisto(
    "MuonPtStubsQual2or3Stubs", "MuonPtStubQual2or3Stubs", 50, 0, 50)
...
MuonEtaStubQual2 = formatHisto(
    "MuonEtaStubsQual2", "MuonEtaStubQual2", 50, -2.5, 2.5)
MuonEtaStubQual2Or3Stubs = formatHisto(
    "MuonEtaStubsQual2or3Stubs", "MuonEtaStubQual2or3Stubs", 50, -2.5, 2.5)

pos2DMuon = formatHisto2D(
    "pos2DMuon", "Eta vs Phi, Global", 50, -2.5, 2.5, 100, -3.14, 3.14)
eta2D = formatHisto2D(
    "etavsRegionEta", "Muon Eta vs Stub Eta", 50, -2.5, 2.5, 13, -6.5, 6.5)
phi2D_Barrel = formatHisto2D(
    "phivsRegionPhi_Barrel", "Muon Phi vs Stub Phi Region (Barrel) ", 100, -3.14, 3.14, 40, -1, 39)
phi2D_Endcap = formatHisto2D(
    "phivsRegionPhi_Endcap", "Muon Phi vs Stub Phi (Endcap)", 100, -3.14, 3.14, 40, -1, 39)

pos2DMuonUgly = formatHisto2D(
    "pos2DMuonUgly", "Eta vs Phi, Global", 50, -2.5, 2.5, 100, -3.14, 3.14)
MuonPtAllUgly = formatHisto("MuonPtAllUgly", "MuonPtAll", 50, 0, 50)
MuonEtaAllUgly = formatHisto("MuonEtaAllUgly", "MuonEtaAll", 50, -2.5, 2.5)
PtEta2DMuonUgly = formatHisto2D(
    "PtEta2DMuonUgly", "Eta vs Pt, Global", 50, -2.5, 2.5, 100, 0, 100)

pos2DMuonClean = formatHisto2D(
    "pos2DMuonClean", "Eta vs Phi, Global", 50, -2.5, 2.5, 100, -3.14, 3.14)
...
PtEta2DMuonClean = formatHisto2D(
    "PtEta2DMuonClean", "Eta vs Pt, Global", 50, -2.5, 2.5, 100, 0, 100)
...
for event in tree:
 ...
 #               print (i,vectorPt.at(i),vectorEta.at(i),vectorPhi.at(i),vectorNStubs.at(i),vectorStubsEtaRegion.at(i).size())
        ...
        for j in range(0, vectorNStubs.at(i)):
            ...
            stubQuality2D.Fill(vectorStubsQuality.at(
                i).at(j), vectorNStubs.at(i))
            stubQuality.Fill(vectorStubsQuality.at(i).at(j))
            depth.Fill(vectorStubsDepthRegion.at(i).at(j))
            stubQualityEta2D.Fill(vectorStubsQuality.at(
                i).at(j), vectorStubsEtaRegion.at(i).at(j))
            stubQualityDepth2D.Fill(vectorStubsQuality.at(
                i).at(j), vectorStubsDepthRegion.at(i).at(j))
            eta2D.Fill(vectorEta.at(i), vectorStubsEtaRegion.at(i).at(j))
            depthEta2D.Fill(vectorStubsDepthRegion.at(i).at(j),
                            vectorStubsEtaRegion.at(i).at(j))
            pos2D.Fill(vectorStubsEtaRegion.at(i).at(
                j), vectorStubsPhiRegion.at(i).at(j))

            depthNStubs2D.Fill(vectorStubsDepthRegion.at(
                i).at(j), vectorNStubs.at(i))
            ...
            if vectorStubsType.at(i).at(j) == 1:
                depthPhi2D_Barrel.Fill(vectorStubsDepthRegion.at(
                    i).at(j), vectorStubsPhiRegion.at(i).at(j))
                stubQualityPhi2D_Barrel.Fill(vectorStubsQuality.at(
                    i).at(j), vectorStubsPhiRegion.at(i).at(j))
                phi2D_Barrel.Fill(vectorPhi.at(
                    i), vectorStubsPhiRegion.at(i).at(j))
            else:
                depthPhi2D_Endcap.Fill(vectorStubsDepthRegion.at(
                    i).at(j), vectorStubsPhiRegion.at(i).at(j))
                stubQualityPhi2D_Endcap.Fill(vectorStubsQuality.at(
                    i).at(j), vectorStubsPhiRegion.at(i).at(j))
                phi2D_Endcap.Fill(vectorPhi.at(
                    i), vectorStubsPhiRegion.at(i).at(j))
...
# stubsStr+=thisStub
        ...
        stationsCrossed = (muonsInSt1 > 0)+(muonsInSt2 > 0) + \
            (muonsInSt3 > 0)+(muonsInSt4 > 0)
