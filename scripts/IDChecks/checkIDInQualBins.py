...
for ptBin in range(0, 16):
    for etaBin in range(0, 14):
        ...
        muonQuality[str(ptBin)+"_"+str(etaBin)] = formatHisto("muonQuality_" +
                                                              str(ptBin)+"_"+str(etaBin), "muonQuality", 300, 0, 300)
        muonPtBin[str(ptBin)+"_"+str(etaBin)] = formatHisto("muonPtBin_" +
                                                            str(ptBin)+"_"+str(etaBin), "muonPtBin", 20, 0, 20)
        muonEtaBin[str(ptBin)+"_"+str(etaBin)] = formatHisto("muonEtaBin_" +
                                                             str(ptBin)+"_"+str(etaBin), "muonEtaBin", 10, 0, 10)

        muonPtEtaBin[str(ptBin)+"_"+str(etaBin)] = formatHisto2D("muonPtEtaBin_" +
                                                                 str(ptBin)+"_"+str(etaBin), "", 20, 0, 20, 10, 0, 10)

        muonPt[str(ptBin)+"_"+str(etaBin)] = formatHisto("muonPt_" +
                                                         str(ptBin)+"_"+str(etaBin), "muonPt", 300, 0, 300)
        muonEta[str(ptBin)+"_"+str(etaBin)] = formatHisto("muonEta_" +
                                                          str(ptBin)+"_"+str(etaBin), "muonEta", 50, -2.5, 2.5)
        muonNStubs[str(ptBin)+"_"+str(etaBin)] = formatHisto("muonNStubs_" +
                                                             str(ptBin)+"_"+str(etaBin), "muon NStubs", 10, 0, 10)
