...
muonPFIsoCharged = formatHisto(
    "muonPFIsoCharged", "muonPFIsoCharged", 50, 0, 100)
muonPFIsoRel = formatHisto("muonPFIsoRel", "muonPFIsoRel", 100, 0, 5)
muonNStubs = formatHisto("muonNStubs", "muonNStubs", 10, 0, 10)

muonIso2D = formatHisto2D(
    "muonIso2D", "muonIso abs vs rel, L/M/T", 4, 0, 4, 4, 0, 4)

muonQualityPt = formatHisto2D(
    "muonQualityPt", "muonQuality vs Pt", 500, 0, 500, 50, 0, 100)
muonIsoPt = formatHisto2D("muonIsoPt", "muonIso vs Pt", 20, 0, 20, 50, 0, 100)
muonPFIsoRelPt = formatHisto2D(
    "muonPFIsoRelPt", "muonPFIsoRel vs Pt", 100, 0, 5, 50, 0, 100)
muonNStubsPt = formatHisto2D(
    "muonNStubsPt", "muonNStubs vs Pt", 10, 0, 10, 50, 0, 100)
...
#                  print ("Cands in DR=0.4:")
        ...
        # Sum with an annulus, 0.002-0.2 (to not self-veto)
            ...
            if dR < 0.2:
                ...
                if vectorPfCandsId.at(k) != 4:
                    ...
                    if dR > 0.02:
                        ...
                        # This ID shows the type. 0== charged particles
        ...
        muonPFIsoRelPt.Fill(sumIsoDR02With002Veto /
                            vectorPt.at(i), vectorPt.at(i))
