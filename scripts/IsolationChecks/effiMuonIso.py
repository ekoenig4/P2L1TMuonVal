###############################################
# EXAMPLE: HW ISOLATION EFFICIENCIES
# ==================================
#
# This file is a example of how to compute HW isolation efficiencies
# (Matching gen Muons to GMT Muons with a very simple dR check)
#
# HwIso is stored in the tree as extracted from the gmtTkMuon object,
# and follows the following convention:
# Bit Code: 1,2,3 Absolute (L/M/T)  ; 4,8,12 Relative (L/M/T)
#
##############################################
...
print("Isolation threshold (HwIso Bit):  %d" % isolationThreshold)
print("=========================================================")
    ...
    for i in range(0, vectorGenPt.size()):
        ...
        if bestDeltaR < 0.1 and matchMuon != -1:
           ...
           # Check also the eta of the l1 muon?
            ...
            # THIS IS THE ISOLATION SELECTION!!! SEE CONFIGURATION
            # SECTION (the HwIso information is encoded: Abs/Rel
            # isolation, three thressholds: Loose/Medium/Tight)
            if vectorIso.at(matchMuon) < isolationThreshold:
                continue
...
print("Saving  the efficiencies in effi_example_%s_%sfilename.root" %
      (name, filename))
